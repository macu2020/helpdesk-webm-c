	<header class="site-header">
	    <div class="container-fluid">
	        ...
	        <a href="#" class="site-logo">
	            <img class="hidden-lg-up" src="../../public/img/icon.png" alt="" width="50">
	        </a>
	            ...
	            <div class="site-header-content-in">
	                    ...
	                    <div class="dropdown user-menu">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
	                            <a class="dropdown-item" href="#">
	                            	<span class="font-icon glyphicon glyphicon-user"></span>Perfil</a>
	                            <a class="dropdown-item" href="#">
	                            	<span class="font-icon glyphicon glyphicon-cog"></span>Configuracion</a>
	                            <a class="dropdown-item" href="#">
	                            	<span class="font-icon glyphicon glyphicon-question-sign"></span>Ayuda</a>
	                            <div class="dropdown-divider"></div>
	                            <a class="dropdown-item" href="../Home/logout.php">
	                            	<span class="font-icon glyphicon glyphicon-log-out"></span>Cerrar Sesión</a>
	                        </div>
	                    </div>
	                ...
	                <div class="site-header-collapsed">
	                    <div class="site-header-collapsed-in">
							...
							<a class="dropdown-item" href="#"><span class="font-icon font-icon-users"></span><?php 
