 ...
 $ticket =  new Ticket();
	 ...
	 switch ($_GET['op']) {
			...
			<?php 
				...
				foreach ($datos as $row) {
					...
					<div class="activity-line-date">					
						<?php echo date("d/m/Y", strtotime($row["fecth_crea"])) ?>
					</div>
					...
					<div class="activity-line-action-list">
						<section class="activity-line-action">
							<div class="time">
				<?php echo date("H:i:s", strtotime($row["fecth_crea"])) ?>
							</div>
							<div class="cont">
								<div class="cont-in">
									<p><?php echo $row['ticked_descrip'] ?></p>
		...
		case 'mostrar':
			...
			if (is_array($datos) == true and count($datos)>0) {
				...
				if ($row['tick_estado'] == "abierto") {
					...
					$output["tick_estado_mostrar"] = $row["tick_estado"];
        ...
        case "update":
            ...
            $ticket->insert_ticketdetalle_cerrar($_POST["tick_id"],$_POST["usu_id"]);//para guarda kien cierra el ticket
        break;  
